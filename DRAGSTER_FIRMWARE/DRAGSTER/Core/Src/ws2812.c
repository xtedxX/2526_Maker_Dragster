...
// Lien vers le handle TIM2 défini dans main.c
extern TIM_HandleTypeDef htim2;
#define WS2812_TIMER              htim2
...
#define WS2812_DUTY_LOW           68
#define WS2812_DUTY_HIGH          136
...
{
    if (htim->Instance == TIM2)  /* was TIM15 */
    {
